...
export class ResendNotificationSender {
    ...
    sendBookingConfirmation(params) {
        ...
        return this.send(to, "Confirmacion de tu alquiler — La Canchita de Carlos", `<p>Hola ${customerName},</p>
    ...
    sendEmailVerification(params) {
        ...
        return this.send(to, "Verifica tu correo — La Canchita de Carlos", `<p>Hola ${name}, tu cuenta fue autorizada. Antes de poder iniciar sesion, confirma que este es
    ...
    sendNewAccessRequestAlert(params) {
        ...
        return this.send(to, "Nueva solicitud de acceso — La Canchita de Carlos", `<p>Hola,</p>
    ...
    sendNewBookingAlert(params) {
        ...
        return this.send(to, "Nueva reserva registrada — La Canchita de Carlos", `<p>Hola,</p>
...
export const notificationSender = new ResendNotificationSender();
//# sourceMappingURL=ResendNotificationSender.js.map