...
export function makeEditBooking(deps) {
    return async function editBooking(bookingId, input) {
        return deps.bookings.runTransaction(async (tx) => {
            ...
            const cambioCanchaUHorario = input.courtId !== undefined || input.date !== undefined || input.startTime !== undefined || input.endTime !== undefined;
...
//# sourceMappingURL=editBooking.usecase.js.map